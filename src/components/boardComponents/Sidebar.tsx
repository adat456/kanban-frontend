...
const Sidebar = function({ setBoardsData, setCurBoardId, setMode, setSidebarVis, setDisplayMsg }) {
    ...
    return (
        <section className="sidebar">
            ...
            <CreateBoard setBoardsData={setBoardsData} setDisplayMsg={setDisplayMsg} />
